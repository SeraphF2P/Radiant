...
const About = () => {
	return (
		...
		>
			...
			<div className=" relative  flex w-full items-center justify-center bg-primary-50   px-4 py-8 ">
				<p className=" max-w-screen-lg">
					At Radiant, we are passionate about using only the best, most
			...
			<section className="relative w-full bg-stone-100  ">
				<div className="mx-auto flex    max-w-screen-lg  flex-col items-center justify-center gap-4    p-4 md:flex-row-reverse ">
					<Image
						wrapperClassName="relative h-72 w-full  overflow-hidden  rounded-[32px]  sm:h-[500px] md:w-1/3"
					...
					<div className="  flex w-full flex-col items-start gap-4  sm:justify-around md:w-2/3">
						...
						<Link
							...
							className={variants({
								variant: "fill",
								className: "capitalise gap-1 px-4 py-2",
							})}
						>
							shop products
